		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
                    ...
                    <div class="col-xs-4">
                        <div class="headerright text-right"><a href="<?php echo site_url('/extensions/FHC-Core-SAPSF/SyncEmployees/syncEmployeesToSAPSF') ?>">Zur Sync FHC -> Success Factors wechseln</a></div>
                    </div>
				</div>
                <div class="row">
